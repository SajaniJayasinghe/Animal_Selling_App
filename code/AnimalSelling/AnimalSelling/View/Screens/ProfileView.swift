...
struct ProfileView: View {
    var body: some View {
        VStack(spacing: 20) {
            ...
            InfoRowView(label: "Email", value: "jayasinghe@gmail.com")
            InfoRowView(label: "Phone", value: "011-222134441")
            InfoRowView(label: "Location", value: "Matara,Akuressa")
